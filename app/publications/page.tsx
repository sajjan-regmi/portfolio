    ...
    <div className="min-h-screen relative">
      <div className="relative z-10 py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* External Links */}
          <section>
            <h2 className="text-3xl font-bold text-primary mb-8">Research Profiles & External Links</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl mb-4">🔬</div>
                  <h3 className="text-lg font-semibold mb-2">ORCID Profile</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Complete academic profile with verified publications and research contributions
                  </p>
                  <Button size="sm" asChild>
                    <Link href="https://orcid.org/0000-0000-0000-0000" target="_blank" rel="noopener noreferrer">
                      <ExternalLink className="h-4 w-4 mr-2" />
                      View ORCID
                    </Link>
                  </Button>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl mb-4">📚</div>
                  <h3 className="text-lg font-semibold mb-2">Google Scholar</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Citation metrics, h-index, and comprehensive publication list
                  </p>
                  <Button size="sm" asChild>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl mb-4">🌲</div>
                  <h3 className="text-lg font-semibold mb-2">ForestAction Nepal</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Policy briefs and research articles on forest governance and community forestry
                  </p>
                  <Button size="sm" asChild>
                    <Link href="https://forestaction.org" target="_blank" rel="noopener noreferrer">
                      <ExternalLink className="h-4 w-4 mr-2" />
                      View Articles
                    </Link>
                  </Button>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl mb-4">📰</div>
                  <h3 className="text-lg font-semibold mb-2">OnlineKhabar</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Popular science articles and opinion pieces on environmental issues
                  </p>
                  <Button size="sm" asChild>
                    <Link href="https://onlinekhabar.com" target="_blank" rel="noopener noreferrer">
                      <ExternalLink className="h-4 w-4 mr-2" />
                      Read Articles
                    </Link>
                  </Button>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  <div className="text-4xl mb-4">🔗</div>
                  <h3 className="text-lg font-semibold mb-2">ResearchGate</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Research collaboration platform with full-text publications and project updates
                  </p>
                  <Button size="sm" asChild>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Professional network and career updates in forestry and environmental research
                  </p>
                  <Button size="sm" asChild>
