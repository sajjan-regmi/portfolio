  ...
  return (
    <html lang="en">
      <body className={`font-sans ${GeistSans.variable} ${GeistMono.variable}`}>
        ...
        <Analytics />
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-b8e30739-3fa4-4938-b931-e03e4ea52481" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_IwlZVkPCXpf"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-b8e30739-3fa4-4938-b931-e03e4ea52481').style.display='none'"
